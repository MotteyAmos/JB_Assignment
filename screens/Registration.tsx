  ...
  return (
    <View style={{
      ...
      <View style={{ width: "100%", backgroundColor: "#fafafa", padding: 10, borderWidth: 1, borderColor: "#F1F4FF", borderRadius: 5, elevation: 1 }}>
        <View style={{ width: "100%", justifyContent: "space-between",flexDirection:"row", alignItems: "flex-end", marginVertical: 15, marginRight: 8,marginBottom:16 }}>
      ...
      <View style={{ width: "100%", backgroundColor: "#fafafa", padding: 10, borderWidth: 1, borderColor: "#F1F4FF", borderRadius: 5, elevation: 1 }}>
        <View style={{ width: "100%", justifyContent: "space-between",flexDirection:"row", alignItems: "flex-end",marginBottom:16 }}>
        <Text style={{}}>Financial Details</Text>
      ...
      <View style={{ width: "100%" }}>
        <TouchableOpacity
          ...
          onPress={() =>[ dispatch(makeDeposite(accountBalance)),navigation.navigate("Home")]}
        >
